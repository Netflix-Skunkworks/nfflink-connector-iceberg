...
public class IcebergCommitterMetrics {
    ...
    public IcebergCommitterMetrics(final Registry registry, final String database, final String table) {
        ...
        skipCommitCheckpointIdMismatch = registry.counter(createId("iceberg_sink.skip_commit_checkpoint_id_mismatch"));
        ...
        fileSizeDistributionHistogram = BucketDistributionSummary.get(registry, fileSizeDistributionHistogramId, sizeBucketingFunc);
    }
    ...
    public void incrementCheckTransactionCompletedFailure(final Throwable t) {
        Id id = checkTransactionCompletedFailureId.withTag(IcebergConnectorConstant.EXCEPTION_CLASS, t.getClass().getSimpleName());
    ...
    public void incrementCreateManifestFileFailure(final Throwable t) {
        Id id = createManifestFileFailureId.withTag(IcebergConnectorConstant.EXCEPTION_CLASS, t.getClass().getSimpleName());
        registry.counter(id).increment();
    }
    ...
    public void incrementPrepareTransactionFailure(final Throwable t) {
        Id id = prepareTransactionFailureId.withTag(IcebergConnectorConstant.EXCEPTION_CLASS, t.getClass().getSimpleName());
        registry.counter(id).increment();
    }
    ...
    public void incrementCommitFailure(final Throwable t) {
        Id id = commitFailureId.withTag(IcebergConnectorConstant.EXCEPTION_CLASS, t.getClass().getCanonicalName());
        registry.counter(id).increment();
    }
