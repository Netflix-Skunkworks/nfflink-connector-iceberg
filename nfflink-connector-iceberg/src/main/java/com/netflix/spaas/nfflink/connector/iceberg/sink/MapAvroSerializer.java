...
public class MapAvroSerializer implements AvroSerializer<Map<String, Object>> {
    ...
    private GenericRecord convert(Map<String, Object> record, Schema avroSchema) throws AvroTypeException {
        ...
        for (Schema.Field field : avroSchema.getFields()) {
            ...
            final Schema actualSchema = AvroUtiils.getActualSchema(field.schema());
            final boolean isOptional = AvroUtiils.isOptional(field.schema());
    ...
    private Object convertFieldValue(Object value, String fieldName, Schema fieldSchema) {
        ...
        switch (fieldSchema.getType()) {
            ...
            case ARRAY:
                ...
                final Schema actualSchema = AvroUtiils.getActualSchema(fieldSchema.getElementType());
                final boolean isOptional = AvroUtiils.isOptional(fieldSchema.getElementType());
